...
public class ParticipateInEventHandler(IEventRepository eventRepository, IGuestRepository guestRepository, IUnitOfWork unitOfWork, ISystemTime systemTime)
    : ICommandHandler<ParticipateInEventCommand>
{
    public async Task<Result> HandleAsync(ParticipateInEventCommand command)
    {
        // Load
