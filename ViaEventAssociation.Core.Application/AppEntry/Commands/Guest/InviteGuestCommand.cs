...
public class InviteGuestCommand
{
    ...
    public static Result<InviteGuestCommand> Create(string eventGuidString, string guestGuidString)
    {
        Error[] errors = [];
        ...
        if (errors.Length > 0) return Result<InviteGuestCommand>.Failure(errors);
