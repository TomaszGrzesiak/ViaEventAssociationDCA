...
public class GuestDeclinesInvitationHandlerTests
{
    ...
    [Fact]
    public async void Id11_S1_GuestIsSuccessfullyDeclinesInvitation_ForPrivateActiveEvent()
    {
        // Arrange
        var eventRepo = new InMemEventRepoStub();
        var guestRepo = new InMemGuestRepoStub();
        var uow = new FakeUoW();
        var handler = new GuestDeclinesInvitationHandler(eventRepo, guestRepo, uow);
        ...
        var cmd = GuestDeclinesInvitationCommand.Create(eventId.ToString(), guestId.ToString()).Payload!;
        ...
        Assert.Contains(ev.Invitations, i =>
            i.GuestId == guest.Id && Equals(i.Status, InvitationStatus.Declined));
    }

    [Fact]
    public async void Id11_F_GuestFailsToDeclineInvitation_ForPrivateActiveEvent_When_EventNotFound()
    {
        // Arrange
        var eventRepo = new InMemEventRepoStub();
        var guestRepo = new InMemGuestRepoStub();
        ...
        var cmd = GuestDeclinesInvitationCommand.Create(wrongEventId.ToString(), guestId.ToString()).Payload!;
    ...
    [Fact]
    public async void Id11_F_GuestFailsToDeclineInvitation_ForPrivateActiveEvent_When_GuestNotFound()
    {
        // Arrange
        var eventRepo = new InMemEventRepoStub();
        var guestRepo = new InMemGuestRepoStub();
        ...
        var cmd = GuestDeclinesInvitationCommand.Create(eventId.ToString(), wrongGuestId.ToString()).Payload!;
    ...
    [Fact]
    public async void Id11_F_GuestFailsToDeclineInvitation_ForPrivateActiveEvent_When_WhenInvitationNotFound()
    {
        // Arrange
        var eventRepo = new InMemEventRepoStub();
        var guestRepo = new InMemGuestRepoStub();
